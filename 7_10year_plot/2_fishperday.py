# 2_fishperday.py
# ------------------------------------------------------------
# Step 2: Calculate average fish per day for each record.
# Creates a new column 'fishperday' equal to:
#   fishperday = adult_diff_plot / day_diff_plot
#
# Notes:
#   • Uses the final biological dataset (csv_10av.csv)
...
# Output : 100_Data/2_fishperday_output.csv + updated csv_10av.csv
# ------------------------------------------------------------

import pandas as pd
from pathlib import Path

print("🏗️ Step 2: Calculating fishperday (adult_diff_plot ÷ day_diff_plot, rounded to 3 decimals)...")
...
output_path  = data_dir / "2_fishperday_output.csv"
...
print(f"🔄 csv_10av.csv updated with new fishperday column")
