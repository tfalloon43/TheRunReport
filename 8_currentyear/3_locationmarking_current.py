# 8_currentyear/3_locationmarking_current.py
# ------------------------------------------------------------
# Step 3 (Current Year): Create all location-based identifier columns
#
# Columns added:
...
# Output : 100_Data/3_locationmarking_current_output.csv + updated csv_currentyear.csv
# ------------------------------------------------------------

import pandas as pd
from pathlib import Path

print("🏗️ Step 3 (Current Year): Creating location-based identifier columns (hatchspecies, hatchfamily, basinfamily, basinspecies)...")
...
output_path  = data_dir / "3_locationmarking_current_output.csv"
...
print(f"🔄 csv_currentyear.csv updated with new columns:")
print("   • hatchspecies")
print("   • hatchfamily")
print("   • basinfamily")
print("   • basinspecies")
print("🎯 Step 3 (Current Year) complete.")