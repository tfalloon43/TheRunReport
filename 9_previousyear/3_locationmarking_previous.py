# 3_locationmarking_previous.py
# ------------------------------------------------------------
# Step 3 (Previous Year): Create all location-based identifier columns
#
# Columns added:
...
# Output : 100_Data/3_locationmarking_previous_output.csv
...
print("🏗️ Step 3 (Previous Year): Creating location-based identifier columns (hatchspecies, hatchfamily, basinfamily, basinspecies)...")
...
output_path  = data_dir / "3_locationmarking_previous_output.csv"
...
print(f"🔄 csv_previousyear.csv updated with new columns:")
print("   • hatchspecies")
print("   • hatchfamily")
print("   • basinfamily")
print("   • basinspecies")
print("🎯 Step 3 (Previous Year) complete.")
