# 7_tablefill_previous.py
# ------------------------------------------------------------
# Step 7 (Previous Year): Populate H/W/U daily tables with fish-per-day values
#
# Logic:
#   • Reads each row from csv_previousyear.csv
...
# Output : Updated *_previous tables with filled-in values
# ------------------------------------------------------------

import pandas as pd
from pathlib import Path

print("🏗️ Step 7 (Previous Year): Populating stock-based *_previous tables with daily fishperday values...")
...
stocks = ["H", "W", "U"]
table_paths = {
    category: {stock: data_dir / f"{category}_{stock.lower()}_previous.csv" for stock in stocks}
...
print(f"✅ Loaded all {total_tables} *_previous base tables from Step 6.")
...
# Summary
# ------------------------------------------------------------
print("✅ Step 7 (Previous Year) complete — *_previous tables updated successfully.")
...
print("🎯 All *_previous tables written to 100_Data/")