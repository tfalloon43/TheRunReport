...
df["adult_diff5"] = df.groupby(group_cols)["Adult Total"].diff()
...
df.loc[df["group_changed"], "adult_diff5"] = df.loc[df["group_changed"], "Adult Total"]
df["adult_diff5"] = df["adult_diff5"].fillna(df["Adult Total"])
