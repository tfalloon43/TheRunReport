# step47_iteration8.py
# ------------------------------------------------------------
# Step 47: Biological Metrics Iteration 8
#
# Recomputes:
#   day_diff8
#   adult_diff8
...
print("🏗️ Step 47: Recomputing biological metrics (Iteration 8)...")
    ...
    for i, r in runs.iterrows():
        ...
        if curr_len > 15:
            ...
            for j in range(i + 1, min(len(runs), i + 5)):
                next_len = runs.loc[j, "by_adult8_length"]
                next_by = runs.loc[j, "by_adult8"]
