...
src_df = pd.read_sql_query("SELECT basinfamily, date_iso, fishperday FROM Escapement_PlotPipeline;", conn)
...
# APPLY TRIM LOGIC
# ------------------------------------------------------------
plot_df = plot_df.merge(reported[["basinfamily", "last_date_obj", "has_fish"]], on="basinfamily", how="left")
